                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    ...
                    <div class="export-btn-area">
                        <a href="javascript:;" class="export_btn"
                            onclick="rightModal('{{ route('teacher.club.add_member', $club->id) }}', '{{ get_phrase('Select Student') }}')">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div
                    ...
                    <form action="{{ route('teacher.club.members', $club->id) }}" method="GET">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2 eDropdown-table-action">
                                        <li>
                                            <a class="dropdown-item" href="javascript:;"
                                                onclick="confirmModal('{{ route('teacher.club.member.delete', $member->id) }}', 'undefined');">{{ get_phrase('Delete') }}</a>
                                        </li>
                                        @if ($member->status == 0)
                                            <li>
                                                <a class="dropdown-item" href="javascript:;"
                                                    onclick="confirmModal('{{ route('teacher.club.member.approve', $member->id) }}', 'undefined');">
                                                    Enable
                                                </a>
                                            </li>
                                        @else
                                            <li>
                                                <a class="dropdown-item" href="javascript:;"
                                                    onclick="confirmModal('{{ route('teacher.club.member.disable', $member->id) }}', 'undefined');">
                                                    Disable
                                                </a>
                                            </li>
                                        @endif
