...
<style>
    .online-exam-attempts-table { min-width: 1320px; }
    .online-exam-attempts-table th, .online-exam-attempts-table td { vertical-align: middle; white-space: nowrap; }
    .online-exam-attempts-actions { min-width: 250px; white-space: normal !important; }
</style>
...
@empty
    <tr><td colspan="13" class="text-center text-muted">{{ get_phrase('No attempts found') }}</td></tr>
@endforelse
