<div class="eoff-form">
    <p class="mb-3">
        ...
        <a href="{{ route('teacher.online_exams.question_bank.import_template') }}">{{ get_phrase('Download a template') }}</a>
    </p>

    <form method="POST" class="d-block" action="{{ route('teacher.online_exams.question_bank.upload') }}" enctype="multipart/form-data">
        @csrf
        <div class="fpb-7">
