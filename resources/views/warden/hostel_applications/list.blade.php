                                            ...
                                            @if ($application->status == 0)
                                                <div class="adminTable-action">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2 eDropdown-table-action">
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:;" onclick="confirmAction('{{ route('warden.hostel.applications.approve', $application->id) }}', '{{ get_phrase('Are you sure to approve this application?') }}')">
                                                                {{ get_phrase('Approve') }}
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:;" onclick="confirmAction('{{ route('warden.hostel.applications.reject', $application->id) }}', '{{ get_phrase('Are you sure to reject this application?') }}')">
                                                                {{ get_phrase('Reject') }}
                                                            </a>
                                                        </li>
                                                    </ul>
