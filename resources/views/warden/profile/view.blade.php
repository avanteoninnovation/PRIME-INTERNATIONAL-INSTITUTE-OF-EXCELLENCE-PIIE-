        ...
        <div class="user-info d-flex flex-column">
            <div class="user-info-basic d-flex flex-column justify-content-center">
                ...
                <div class="userContent text-center">
                    ...
                    <p class="info">{{ get_phrase('Warden') }}</p>
                    ...
                    <div class="eForm-layouts">
                        <form action="{{ route('warden.profile.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="fpb-7">
                                ...
                                <input type="text" class="form-control eForm-control" id="designation" name="designation" value="{{ auth()->user()->designation }}" placeholder="Enter your designation" />
                            </div>
                            ...
                            <div class="fpb-7">
                                ...
                                @endphp
                                <input type="text" class="form-control eForm-control" id="eInputDate" name="eDefaultDateRange" value="{{ date('m/d/Y', $birthday) }}" />
                            </div>
                            <div class="fpb-7">
                            ...
                            <div class="fpb-7">
                                ...
                                <input type="number" class="form-control eForm-control" id="eInputPhone" name="phone" value="{{ json_decode(auth()->user()->user_information, true)['phone'] }}" placeholder="00 (00) 12345 6789" aria-label="00 (00) 12345 6789" />
                            </div>
                            <div class="fpb-7">
                                <label for="eInputAddress" class="eForm-label">{{ get_phrase('Address') }}</label>
                                <input type="text" class="form-control eForm-control" id="eInputAddress" name="address" value="{{ json_decode(auth()->user()->user_information, true)['address'] }}" placeholder="Enter Address" aria-label="Enter Address" />
                            </div>
