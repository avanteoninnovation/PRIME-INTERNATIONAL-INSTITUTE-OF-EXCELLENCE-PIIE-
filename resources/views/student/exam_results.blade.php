...
<div class="mainSection-title d-print-none"><div class="row"><div class="col-12">
    <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
        <div class="d-flex flex-column">
            <h4>{{ get_phrase('My Exam Results') }}</h4>
            <ul class="d-flex align-items-center eBreadcrumb-2">
                <li><a href="{{ route('student.dashboard') }}">{{ get_phrase('Home') }}</a></li>
                <li><a href="#">{{ get_phrase('My Exam Results') }}</a></li>
            </ul>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('student.exam_results.pdf') }}" class="eBtn eBtn-primary">
...
<div class="eSection-wrap" id="transcript-doc" style="max-width:800px;margin:0 auto">
    ...
    <div class="p-4">
        ...
        <div class="text-center text-muted py-4">
            ...
            <div class="mt-2">{{ get_phrase('No results published yet') }}</div>
        </div>
        @else
