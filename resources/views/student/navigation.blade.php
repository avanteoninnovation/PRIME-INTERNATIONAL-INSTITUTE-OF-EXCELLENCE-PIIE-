...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
                ...
                <div class="iocn-link">
                    <a class="{{ request()->is('student/appraisal-list*') || request()->is('student/start-appraisal/*') ? 'active' : '' }}" href="{{ route('student.appraisal.appraisalList') }}">
                        <div class="sidebar_icon mt-4">
                            <?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 106.86 122.88" style="enable-background:new 0 0 106.86 122.88"
                                xml:space="preserve">
                                <style type="text/css">
                                    .st0 {
                                        fill-rule: evenodd;
            ...
            <li class="nav-links-li {{ request()->is('student/book*') || request()->is('student/book_issue*') || request()->is('student/noticeboard*') || request()->is('student/events/list*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                  ...
                  border-radius: 50%; width: 18px; height: 18px; margin-top: 5px; margin-left: 5px; line-height: 20px;">
                                <h5 style="font-size: 10px;  color: #fff; margin-top: -7px;display: flex; justify-content: center; ">{{ $notice_count }}</h5>
                            </span>
                        @else
                            <span class="link_name">{{ get_phrase('Back Office') }}</span>
                        @endif
            ...
            <li class="nav-links-li {{ request()->is('student/hostel_*') || request()->is('student/hostel-applications*') || request()->is('student/hostel_fee*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon mt-4">
                ...
                <ul class="sub-menu">
                    ...
                    @if (empty($user->menu_permission) || in_array('student.hostel.applications', $menu_permission))
                        <li>
                            <a class="{{ request()->is('student/hostel-applications*') ? 'active' : '' }}" href="{{ route('student.hostel.applications') }}">
                                <span>{{ get_phrase('Application') }}</span>
                            </a>
                        </li>
                    @endif

                    @if (($hasApplications || $hasHostelFees) && (empty($user->menu_permission) || in_array('student.hostel.fee_manager', $menu_permission)))
                        <li>
                            <a class="{{ request()->is('student/hostel_fee*') ? 'active' : '' }}" href="{{ route('student.hostel_fee_manager.list') }}">
