<!-- marzpay -->
<div class="tab-pane fade <?= $off ?>" id="v-pills-marzpay" role="tabpanel" aria-labelledby="v-pills-marzpay-tab" tabindex="0">
    <div class="off_payment_form">

        <form action="{{ route('student.payment.marzpay.start', ['id' => $fee_details['id']]) }}" method="post" class="marzpay-form form">
            @csrf
