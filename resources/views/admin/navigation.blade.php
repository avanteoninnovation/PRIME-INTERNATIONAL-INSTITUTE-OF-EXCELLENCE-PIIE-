    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
                ...
                <li
                    ...
                    <ul class="sub-menu">
                        ...
                        @if (empty($user->menu_permission) || in_array('admin.warden', $menu_permission))
                            <li><a class="{{ request()->is('admin/warden') ? 'active' : '' }}" href="{{ route('admin.warden') }}"><span>
                                        {{ get_phrase('Warden') }}
                                    </span></a></li>
                        @endif
                ...
                <li class="nav-links-li {{ request()->is('admin/offline_admission*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a class="{{ request()->is('admin/offline_admission*') ? 'active' : '' }}" href="{{ route('admin.offline_admission.single', ['type' => 'single']) }}">
                            <div class="sidebar_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Isolation_Mode" data-name="Isolation Mode" viewBox="0 0 24 24" width="48" height="48">
            ...
            @if (addon_status('transport') == 1)
                <li class="nav-links-li {{ request()->is('admin/driver/list*') || request()->is('admin/vehicle/list*') || request()->is('admin/assign/student/list*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="48" height="48" id="Layer_1" data-name="Layer 1">
                                    <path
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="{{ request()->is('admin/driver/list') ? 'active' : '' }}" href="{{ route('admin.driver.list') }}"><span>{{ get_phrase('Driver') }}</span></a>
                        </li>
                        <li>
                            <a class="{{ request()->is('admin/vehicle/list') ? 'active' : '' }}" href="{{ route('admin.vehicle.list') }}"><span>{{ get_phrase('Vehicle') }}</span></a>
                        </li>
                        <li>
                            <a class="{{ request()->is('admin/assign/student/list') ? 'active' : '' }}" href="{{ route('admin.assign.student.list') }}"><span>{{ get_phrase('Assign student') }}</span></a>
                        </li>
            ...
            @if (addon_status('inventory_manager') == 1)
                <li class="nav-links-li {{ request()->is('admin/inventory/list*') || request()->is('admin/category/list*') || request()->is('admin/buy_sell_inventory*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a class="{{ request()->is('admin/inventory/list') ? 'active' : '' }}" href="{{ route('admin.inventory.list') }}">
                                <span>
                        ...
                        <li>
                            <a class="{{ request()->is('admin/category/list') ? 'active' : '' }}" href="{{ route('admin.category.list') }}">
                                <span>
                        ...
                        <li>
                            <a class="{{ request()->is('admin/buy_sell_inventory') ? 'active' : '' }}" href="{{ route('admin.buy_sell_inventory') }}">
                                <span>
            ...
            @if (addon_status('alumni_manager') == 1)
                <li class="nav-links-li {{ request()->is('admin/alumni*') || request()->is('admin/alumni/gallery_alumni*') || request()->is('admin/alumni/event_alumni*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" id="alumni" class="bi bi-mortarboard mt-3">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a class="{{ request()->is('admin/alumni/alumni_manager') ? 'active' : '' }}" href="{{ route('admin.alumni.index') }}">
                                <span>
                        ...
                        <li>
                            <a class="{{ request()->is('admin/alumni/event_alumni') ? 'active' : '' }}" href="{{ route('admin.alumni.eventindex') }}">
                                <span>
                                    {{ get_phrase('Events') }}
                                </span>
                                {{-- <span class="badge bg-success m-1" style="">{{ get_phrase('Addon') }}</span> --}}
                        ...
                        <li>
                            <a class="{{ request()->is('admin/alumni/gallery_alumni') ? 'active' : '' }}" href="{{ route('admin.alumni.galleryindex') }}">
                                <span>
                                    {{ get_phrase('Gallery') }}
                                </span>
                                {{-- <span class="badge bg-success m-1" style="">{{ get_phrase('Addon') }}</span> --}}
            ...
            @if (addon_status('sms_center') == 1)
                <li class="nav-links-li {{ request()->is('admin/sms_center*') || request()->is('admin/sms_center/sms_settings*') || request()->is('admin/sms_center/sms_sender*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="{{ request()->is('admin/sms_center/sms_settings') ? 'active' : '' }}" href="{{ route('admin.sms_center.index') }}">
                                <span>
                        ...
                        <li>
                            <a class="{{ request()->is('admin/sms_center/sms_sender') ? 'active' : '' }}" href="{{ route('admin.sms_center.sms_sender') }}">
                                <span>
            ...
            @if (empty($user->menu_permission) || in_array('admin.appraisal.appraisalQuestions', $menu_permission) || in_array('admin.appraisal.studentFeedback', $menu_permission))
                <li class="nav-links-li {{ request()->is('admin/appraisal-question*') || request()->is('admin/appraisal-student-feedback*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon mt-4">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 106.86 122.88" style="enable-background:new 0 0 106.86 122.88" xml:space="preserve">
                                    <style type="text/css">
                                        .st0 {
                                            fill-rule: evenodd;
                                            clip-rule: evenodd;
                    ...
                    <ul class="sub-menu">
                        @if (empty($user->menu_permission) || in_array('admin.appraisal.appraisalQuestions', $menu_permission))
                            <li><a class="{{ request()->is('admin/appraisal-question') ? 'active' : '' }}" href="{{ route('admin.appraisal.appraisalQuestions') }}"><span>
                ...
                <li
                    ...
                    <ul class="sub-menu">
                        @if (empty($user->menu_permission) || in_array('admin.hostel.hostel_list', $menu_permission))
                            <li><a class="{{ request()->is('admin/hostel-list*') ? 'active' : '' }}" href="{{ route('admin.hostel.hostel_list') }}"><span>
                                        {{ get_phrase('Hostel list') }}
                                    </span></a></li>
                        @endif
                        @if (empty($user->menu_permission) || in_array('admin.hostel.room_list', $menu_permission))
                            <li><a class="{{ request()->is('admin/hostel-room-list*') ? 'active' : '' }}" href="{{ route('admin.hostel.room_list') }}"><span>
                                        {{ get_phrase('Room list') }}
                                    </span></a></li>
                        @endif
                        @if (empty($user->menu_permission) || in_array('admin.hostel.allocation_list', $menu_permission))
                            <li><a class="{{ request()->is('admin/hostel-room-allocation-list*') ? 'active' : '' }}" href="{{ route('admin.hostel.allocation_list') }}"><span>
                                        {{ get_phrase('Allocation list') }}
                                    </span></a></li>
                        @endif
                        @if (empty($user->menu_permission) || in_array('admin.hostel.applications', $menu_permission))
                            <li><a class="{{ request()->is('admin/hostel-applications*') ? 'active' : '' }}" href="{{ route('admin.hostel.applications') }}"><span>
                                        {{ get_phrase('Applications') }}
                                    </span></a></li>
                        @endif
                        @if (empty($user->menu_permission) || in_array('admin.hostel_fee_manager.list', $menu_permission))
                            <li><a class="{{ request()->is('admin/hostel-fee-manager*') ? 'active' : '' }}" href="{{ route('admin.hostel_fee_manager.list') }}"><span>
                                        {{ get_phrase('Hostel Fees') }}
                                    </span></a></li>
                        @endif
                        @if (empty($user->menu_permission) || in_array('admin.offline.payment.hostel.list', $menu_permission))
                            <li><a class="{{ request()->is('admin/hostel-fee/offline-payment/list*') ? 'active' : '' }}" href="{{ route('admin.offline.payment.hostel.list') }}"><span>
