    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                ...
                <a href="{{ route('admin.live_classes.show', $liveClass->id) }}" class="eBtn eBtn-dark">{{ get_phrase('Back') }}</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="eSection-wrap">
            <form method="POST" action="{{ route('admin.live_classes.update', $liveClass->id) }}">
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.live_classes.show', $liveClass->id) }}" class="eBtn eBtn-dark">{{ get_phrase('Cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
