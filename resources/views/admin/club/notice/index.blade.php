                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    ...
                    <div class="export-btn-area">
                        <a href="javascript:;" class="export_btn"
                            onclick="rightModal('{{ route('admin.club.notice.create', $club->id) }}', '{{ get_phrase('Create Notice') }}')">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="javascript:;"
                                            onclick="rightModal('{{ route('admin.club.notice.edit', $notice->id) }}','{{ get_phrase('Edit Notice') }}')">
                                            {{ get_phrase('Edit') }}
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="javascript:;"
                                            onclick="confirmModal('{{ route('admin.club.notice.delete', $notice->id) }}','undefined')">
                                            {{ get_phrase('Delete') }}
                                        </a>
                                    </li>
                                </ul>
