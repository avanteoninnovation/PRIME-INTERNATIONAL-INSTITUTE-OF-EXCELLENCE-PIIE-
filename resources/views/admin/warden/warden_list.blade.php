...
@section('content')
                    ...
                    @if (count($wardens) > 0)
                        <div class="position-relative">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                                ...
                                <li>
                                    <a class="dropdown-item" id="print" href="javascript:;" onclick="printableDiv('warden_list')">{{ get_phrase('Print') }}</a>
                                </li>
                            </ul>
                        </div>
                    @endif
    ...
    @if (count($wardens) > 0)
        <!-- Table -->
        <div class="table-responsive warden_list display-none-view" id="warden_list">
            <h4 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #1466AF; margin-left:45%; margin-bottom:15px; margin-top:17px;">{{ get_phrase('Wardens List') }}</h4>
            <table class="table eTable eTable-2">
                <thead>
                    <tr>
                        <th scope="col">#</th>
    ...
    <script type="text/javascript">
        ...
        function Export() {
            ...
            const element = document.getElementById("warden_list");
            ...
            var opt = {
                margin: 1,
                filename: 'warden_list_{{ date('y-m-d') }}.pdf',
                image: {
                    type: 'jpeg',
                    quality: 0.98
                },
