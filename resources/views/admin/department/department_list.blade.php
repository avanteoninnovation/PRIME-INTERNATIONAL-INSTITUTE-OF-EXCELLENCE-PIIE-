...
<div class="table-responsive department_list display-none-view" id="department_list">
  <h4 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #1466AF; margin-left:7%; margin-bottom:15px; margin-top:17px;">{{ get_phrase('Department List') }}</h4> 
    <table class="table eTable">
        <thead>
            <tr>
                <th>#</th>
