...
<div class="table-responsive class_list display-none-view" id="class_list">
  <h4 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #1466AF; margin-left:45%; margin-bottom:15px; margin-top:17px;">{{ get_phrase('Class List') }}</h4> 
      <table class="table eTable">
        <thead>
            <tr>
                <th scope="col">#</th>
