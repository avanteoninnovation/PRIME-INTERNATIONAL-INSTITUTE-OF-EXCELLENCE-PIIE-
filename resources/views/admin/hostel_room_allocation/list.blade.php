            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    ...
                    <div class="export-btn-area">
                        <a href="javascript:;" class="export_btn" onclick="rightModal('{{ route('admin.hostel.create_allocation') }}', '{{ get_phrase('Create Hostel Room Allocation') }}')">{{ get_phrase('Add Hostel Room Allocation') }}</a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <td class="text-center">
                                            <div class="adminTable-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2 eDropdown-table-action">
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:;" onclick="rightModal('{{ route('admin.hostel.edit_allocation', ['id' => $allocation->id]) }}', '{{ get_phrase('Edit Hostel Room Allocation') }}')">{{ get_phrase('Edit') }}</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:;" onclick="confirmModal('{{ route('admin.hostel.delete_allocation', ['id' => $allocation->id]) }}', 'undefined');">{{ get_phrase('Delete') }}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
